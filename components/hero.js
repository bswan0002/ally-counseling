...
export default function Hero() {
  return (
    <>
      ...
      <button className="hero-button text-white bg-gray-900 bg-opacity-20 hover:bg-blue-400 hover:bg-opacity-50 transition duration-150 ease-in-out border-white border-2 rounded-lg py-2 px-4">
        Get Started
      </button>
    </>
  );
