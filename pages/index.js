        ...
        <div className="animated-gradient pt-4 pb-8 mt-4 shadow-lg">
          <Layout px={2}>
            ...
            <p className="my-3 font-serif tracking-wide">
              ...
              improve their lives. Ally Counselors strongly believe that
              everyone deserves a wonderful life and is capable of reaching that
              goal. Life can be challenging and sometimes you need an Ally who
              has the knowledge, skills, and determination to help you live life
              to the fullest. Whether aspiring to improve your personal life,
              academics, career, relationships, Ally Counselors help people
              bring out their best so they can make positive and lasting changes
              in their lives.
            </p>
        ...
        <div className="pt-4 pb-10">
          <Layout px={2}>
            ...
            <p className="my-3 font-serif tracking-wide">
              ...
              struggling with new or chronic issues that are preventing them
              from achieving their full potential in life, academics,
              relationships, or careers. They enjoy partnering with their
              clients to help them discover or get back on track with the things
              that make them feel motivated, happy, and fulfilled.
            </p>
          </Layout>
          <div className="mt-6 grid grid-cols-1 sm:grid-cols-5 max-w-screen-lg mx-auto rounded-lg shadow-lg">
            <div className="col-span-2 order-2 sm:order-1 flex flex-col justify-center bg-gray-100">
              <p className="font-serif italic p-3">
                I love seeing my clients get excited about making positive
                changes in their lives and I appreciate the opportunity to
                support my clients through that process.
              </p>
